...
class AppTheme {
  ...
  // 타이포그래피 — 공통
  static TextStyle navItem(bool isMobile) => TextStyle(
    fontFamily: 'Raleway',
  ...
  static TextStyle mainSectionTitle(bool isMobile) => GoogleFonts.montserrat(
    fontSize: isMobile ? 24 : 18,
    fontWeight: FontWeight.w800,
    letterSpacing: 3,
    color: black,
  );
  static TextStyle bodyKorean(bool isMobile) => GoogleFonts.notoSansKr(
    fontSize: isMobile ? 20 : 16,
    fontWeight: FontWeight.w400,
    color: black,
  );
  static TextStyle pageTitle(bool isMobile) => TextStyle(
    fontFamily: 'BMHanna',
  ...
  // About — Brand 섹션
  static TextStyle brandTitle() => GoogleFonts.montserrat(
    fontSize: 34,
    fontWeight: FontWeight.w900,
    color: white,
  );
  static TextStyle brandBodyText() => GoogleFonts.notoSansKr(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: white,
    height: 2.0,
  ...
  // Contact
  static TextStyle contactBody() => GoogleFonts.notoSansKr(
    fontSize: 20,
    fontWeight: FontWeight.w400,
    height: 1.5,
    color: black,
