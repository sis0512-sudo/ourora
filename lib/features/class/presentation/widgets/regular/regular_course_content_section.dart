...
class RegularCourseContentSection extends StatelessWidget {
  const RegularCourseContentSection({super.key});
    ...
    return Column(
      children: [
        ...
        RegularCard(
          ...
          descriptionStyle: descriptionStyle,
          image: Image.asset('assets/images/regular_course_timetable.webp', width: 600, fit: BoxFit.contain),
        ),
      ],
    );
  }
