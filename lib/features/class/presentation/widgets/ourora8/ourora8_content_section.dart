...
class Ourora8ContentSection extends StatefulWidget {
  final bool isMobile;

  const Ourora8ContentSection({super.key, required this.isMobile});

  @override
  State<Ourora8ContentSection> createState() => _Ourora8ContentSectionState();
}

class _Ourora8ContentSectionState extends State<Ourora8ContentSection> {
  bool _hovered = false;

  final EdgeInsetsGeometry _titlePadding = const EdgeInsets.only(top: 60, bottom: 40);
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Padding(
          padding: EdgeInsets.symmetric(horizontal: widget.isMobile ? 0 : 40, vertical: 40),
          child: Column(
            children: [
              Text(
